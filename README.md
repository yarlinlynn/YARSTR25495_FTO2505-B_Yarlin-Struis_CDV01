...
- A strong emphasis on **flexibility**, allowing for adaptability, creative problem-solving, and support for work-life balance.
...
- **Freelance Developer**: Freelancing appeals to me for it's flexibility and the opportunity to work on diverse projects across different industries. This will give me the freedom to apply my skills on my own terms, and gradually create a steady income alongside full-time employment.
- **Frontend Web Developer**: My interest for front-end development stems from creating visually engaging, user-centric interfaces. Front-end roles allow me to combine creativity with logic, which is especially relevant for building real-world, client-facing products in both full-time and freelance settings.
...
- **Cybersecurity-focused software development**: I’m interested in a career in software development, with a focus on cybersecurity. I’d like to create/build software that helps to detect and manage harmful or suspicious behavior, making the internet a safer place for everyone.
- **Coding Teacher**: Once I’m an established developer, I hope to teach coding to young students, particularly those between the ages of 9 and 15. I want to help them build confidence in their technical skills early on, encourage creativity through programming, and show them the positive impact they can have with technology. This reflects my willingness to help others and reinforces my own knowledge and opens up opportunities for community involvement or even side-income as a mentor or instructor.
...
- Cybersecurity in software developement, allowing me to combine my passion for technology with a strong commitment to online safety. Ultimately, I see this career as a way to make a meaningful impact through technology, while also paving the way for future initiatives in education and community engagement.
...
-  In the future, I hope to incorporate **AI technologies** into my projects to streamline development, improve code quality, and create more responsive, intelligent web applications. By combining my **skills in full-stack development with the capabilities of AI**, I aim to build smarter, more innovative digital solutions.
...
2. **Preparation for Long-term Goals**:<br/>
   **1. Technical Skill Development (Ongoing)**
...
- Offer services like: landing pages, site redesigns, bug fixes.
...
- Certifications: FreeCodeCamp or Scrimba front-end certifications. JavaScript Algorithms and Data Structures.<br/>
...
- Create a clean GitHub profile with pinned repositories, README.md summaries, and live demos.<br/>
